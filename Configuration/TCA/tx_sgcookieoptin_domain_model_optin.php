...
$configuration = [
	...
	'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, header, description, cookie_lifetime,
			...
			iframe_selection, iframe_replacement_html, iframe_replacement_overwritten, iframe_external_scripts, iframe_replacement_selection,
		...
		'1' => [
			'showitem' => '
				...
				--div--;LLL:EXT:sg_cookie_optin/Resources/Private/Language/locallang_db.xlf:tx_sgcookieoptin_domain_model_optin.tab.iframes,
					...
					--;;--palette--;;, iframe_external_scripts,
	...
	'columns' => [
		...
		'iframe_external_scripts' => [
			'exclude' => TRUE,
			'label' => 'LLL:EXT:sg_cookie_optin/Resources/Private/Language/locallang_db.xlf:tx_sgcookieoptin_domain_model_optin.external_scripts',
			'config' => [
				'type' => 'inline',
				'foreign_table' => 'tx_sgcookieoptin_domain_model_script',
				'foreign_field' => 'parent_optin_external',
				'foreign_sortby' => 'sorting',
				'appearance' => [
					'showPossibleLocalizationRecords' => TRUE,
					'showRemovedLocalizationRecords' => FALSE,
