...
CREATE TABLE tx_sgcookieoptin_domain_model_optin (
	...
	extend_box_link_text varchar(255) DEFAULT 'Weitere Informationen' NOT NULL,
	extend_table_link_text varchar(255) DEFAULT 'Cookie-Informationen' NOT NULL,
	...
	color_button_close varchar(255) DEFAULT '#A5A5A5' NOT NULL,
	color_button_close_hover varchar(255) DEFAULT '#D7D7D7' NOT NULL,
	color_button_close_text varchar(255) DEFAULT '#FFFFFF' NOT NULL,
