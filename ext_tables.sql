...
CREATE TABLE tx_sgcookieoptin_domain_model_optin (
	...
	cookie_name_text varchar(255) DEFAULT '' NOT NULL,
	cookie_provider_text varchar(255) DEFAULT '' NOT NULL,
	cookie_purpose_text varchar(255) DEFAULT '' NOT NULL,
	cookie_lifetime_text varchar(255) DEFAULT '' NOT NULL,
