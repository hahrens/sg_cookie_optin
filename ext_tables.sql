...
CREATE TABLE tx_sgcookieoptin_domain_model_optin (
	...
	banner_color_button_settings varchar(10) DEFAULT '#A5A5A5' NOT NULL,
	...
	color_button_specific varchar(10) DEFAULT '#A5A5A5' NOT NULL,
	...
	color_button_essential varchar(10) DEFAULT '#A5A5A5' NOT NULL,
	...
	color_list varchar(10) DEFAULT '#A5A5A5' NOT NULL,
